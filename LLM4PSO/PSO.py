...
class PSO:
    def __init__(self, func, n_pop, dim, c1, c2, position_bound: list, velocity_bound: list):
    ...
    # def run(self, max_iter=1000, omega=0.729, flag='normal', verbose=True):
    #     """ 主循环 """
    #     self.pop_init()
